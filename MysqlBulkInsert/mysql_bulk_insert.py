                ...
                async with pool.acquire() as conn:
                    async with conn.cursor() as cur:
                        ...
                        if (tbl_work_num == 2): ## DELETE
                            await cur.execute(f"DELETE FROM test{rnd_num} WHERE seq_1 IN (floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000))")
                            await conn.commit()
                        if (tbl_work_num == 3): ## UPDATE
                            await cur.execute(f"UPDATE test{rnd_num} SET seq_1=floor(rand()*1000000), seq_2=floor(rand()*1000000), seq_3=floor(rand()*1000000) WHERE seq_1 IN (floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000), floor(rand()*1000000))")
                            await conn.commit()
